...
const CommunitySpotlight = () => {
  ...
  if (loading) {
    return (
      <div className="text-center py-8">
        ...
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Loading featured resources...</p>
      </div>
    )
  }
  ...
  if (featured.length === 0) {
    return (
      <div className="text-center py-8">
        <p className="text-sm text-slate-600 dark:text-slate-400">No featured resources yet. Check back soon!</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">Community Spotlight</h3>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sky-600 dark:text-sky-400 mb-1">{resource.category}</p>
                ...
                {resource.rating && (
                  <div className="mt-1 flex items-center gap-1">
                    ...
                    <span className="text-xs text-slate-600 dark:text-slate-400">{resource.rating}</span>
                  </div>
                )}
              </div>
            </div>
